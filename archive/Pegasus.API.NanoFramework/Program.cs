    ...
    public class Program
    {
...
#if HAS_WIFI
        private static string wifiSsid = "Starbender";
        private static string wifiPassword = "Ityo19()";
#endif
        ...
        public static void Main()
        {
            ...
            try
            {
                ...
                using (WebServer server = new WebServer(443, HttpProtocol.Https, new Type[] { typeof(PocketPowerBoxController) }))
#else
